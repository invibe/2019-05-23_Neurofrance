...
get_figures:
	...
	# methods
	rsync -a ../AnticipatorySPEM/figures/Result/{Results_BCP_velocity_sigmo_0,Results_BCP_velocity_sigmo_1,scatter_velocity_sigmo_leaky,scatter_velocity_sigmo_leaky,scatter_velocity_sigmo_mean}.svg figures
	# KDE
